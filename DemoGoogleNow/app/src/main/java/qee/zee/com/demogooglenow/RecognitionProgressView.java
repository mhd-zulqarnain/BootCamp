...
package qee.zee.com.demogooglenow;
...
import qee.zee.com.demogooglenow.animators.RmsAnimator;
...
public class RecognitionProgressView extends View implements RecognitionListener {
  ...
  private Paint paint;
  private qee.zee.com.demogooglenow.animators.BarParamsAnimator animator;
  ...
  private void startIdleInterpolation() {
    animator = new qee.zee.com.demogooglenow.animators.IdleAnimator(recognitionBars, amplitude);
    animator.start();
  }

  private void startRmsInterpolation() {
    resetBars();
    animator = new qee.zee.com.demogooglenow.animators.RmsAnimator(recognitionBars);
    animator.start();
  }

  private void startTransformInterpolation() {
    resetBars();
    /*animator = new TransformAnimator(recognitionBars, getWidth() / 2, getHeight() / 2);
    animator.start();*/
